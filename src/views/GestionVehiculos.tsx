...
import { 
    ...
    ShieldAlert, ShieldCheck, History, Save 
} from 'lucide-react';
import type { Vehiculo, RutaPrincipal, VariacionRuta } from '../types';
...
const GestionVehiculos: React.FC = () => {
    const { 
        ...
        conductores, multas, registrarPago 
    } = useStore();
    ...
    const handleSave = (e: React.FormEvent) => {
        ...
        if (isEditing && selectedVehiculo) {
            ...
            setSelectedVehiculo({ ...selectedVehiculo, ...formData });
            setIsEditing(false);
            ...
            <header className="flex justify-between items-center">
                ...
                <button 
                    onClick={() => {
                        setShowAddForm(true);
                        setIsEditing(false);
                        setFormData({ id: '', propietario: '', patente: '', modelo: '', anio: 2024, vencimientoRevisionTecnica: '', vencimientoSeguro: '', rutaPrincipal: 'Troncal' });
                    }}
